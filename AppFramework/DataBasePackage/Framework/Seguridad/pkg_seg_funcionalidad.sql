CREATE OR REPLACE PACKAGE PKG_SEG_FUNCIONALIDAD AS
        ...
        PROCEDURE PRC_MENU_ITEM_OBT(ec_usuario VARCHAR2, ec_sistema VARCHAR2, sq_resultado out sys_refcursor);
...
CREATE OR REPLACE PACKAGE BODY PKG_SEG_FUNCIONALIDAD AS    
    ...
    PROCEDURE PRC_MENU_ITEM_OBT(ec_usuario VARCHAR2, ec_sistema VARCHAR2, sq_resultado out sys_refcursor) IS
    BEGIN
