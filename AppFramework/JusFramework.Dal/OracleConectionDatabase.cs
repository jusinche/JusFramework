...
namespace JusFramework.Dal
{
    ...
    ///</summary>
    [Serializable]
    public class OracleConectionDatabase : DatabaseConection
    {
        public OracleConectionDatabase(string conxString)
        {
            if (string.IsNullOrEmpty(conxString))
                throw new ArgumentException();


            TraslateException = new DBConectionException("");
        ...
        public override object ExecuteScalar(IDbCommand command)
        {
            ...
            catch (OracleException oracleException)
            {
                ...
                {
                    texto = texto + parameter.ToString();
                }
                //throw new JusException(command.CommandText+" "+ texto, oracleException);
