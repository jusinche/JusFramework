...
namespace JusFramework.Dal
{
    ...
    ///</summary>
    [Serializable]
    public abstract class DatabaseConection : IDisposable, IDatabaseConection
    {
        protected IDbConnection _activeConnection;
        protected List<IDbCommand> _createdCmds;
        protected bool _disposed;
        DBConectionException _traslateException;
        ...
        /// </summary>
        protected DBConectionException TraslateException
        {
