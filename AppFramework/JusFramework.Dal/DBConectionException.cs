...
namespace JusFramework.Dal
{
    ...
    /// </summary>
    public class DBConectionException : JusExceptionBase
    {
        /// <summary>
        ...
        /*public  SyDataBaseException Handler(DbException ex, string infoLog)
        {
            //TODO: FALTA TRATAR MENSAJES DE CADA EXCEPCION MAS MENSAJE DE LOGS
            SyDataBaseException objeto = null;
            string msg = string.Empty;

            //TODO  GENERAR EL MENSAJE A PARTIR DEL CODIGO DEL ERROR PARA NO ESTAR QUEMANDO LOS MENSAJES 
                ...
                if (exception != null)
                {
                    switch (exception.Number)
                    {
                        ...
                        case CodigosErroresOracle.PARENT_KEY_NOT_FOUND:
                            //TODO: NO SE DEBE COLOCAR MENSAJES AMIGABLES EN EXCEPCIONES DE BASE DE DATOS, EXISTE UNA CLASE QUE VISUALIZA MENSAJES AMIGABLES SEGUN UNA CONFIGURACION
                            msg =
                        ...
                        case CodigosErroresOracle.NOT_DATA_FOUND:
                            //TODO:  REVISAR LA INTERPRETACION DEL ERROR
                            msg = "NOT_DATA_FOUND\n" + infoLog;
        ...
        public override void ExManager(Exception ex)
        {
            ...
            //todo: Implementar aqui la excepcion
        }

        public DBConectionException(string msjAmigable)
