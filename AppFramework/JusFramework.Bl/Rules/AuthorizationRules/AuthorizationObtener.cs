...
{
    public class AuthorizationObtener : Csla.Rules.AuthorizationRule
    {
        // TODO: Add additional parameters to your rule to the constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorizationObtener"/> class.
        /// </summary>
        /// <param name="action">Action this rule will enforce.</param>
        /// <param name="element">Method or property.</param>
        public AuthorizationObtener(AuthorizationActions action, IMemberInfo element)
            : base(action, element)
        {
        ...
        public AuthorizationObtener(AuthorizationActions action)
            : base(action)
        {
            // TODO: Add additional constructor code here 
