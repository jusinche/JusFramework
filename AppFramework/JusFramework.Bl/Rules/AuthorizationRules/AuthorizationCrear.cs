...
{
    public class AuthorizationCrear : Csla.Rules.AuthorizationRule
    {
        // TODO: Add additional parameters to your rule to the constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorizationCrear"/> class.
        /// </summary>
        /// <param name="action">Action this rule will enforce.</param>
        /// <param name="element">Method or property.</param>
        public AuthorizationCrear(AuthorizationActions action, IMemberInfo element)
            : base(action, element)
        {
        ...
        public AuthorizationCrear(AuthorizationActions action)
            : base(action)
        {
            // TODO: Add additional constructor code here 
        ...
        protected override void Execute(AuthorizationContext context)
        {
            ...
            //this.Action=AuthorizationActions.CreateObject;
        }
    }
}